...
def main():
    ...
    #
    # priors.append(('_b2_1', (0,3)))   # for a constant galaxy bias in bin 1
    # priors.append(('_b2_2', (0,3)))   # for a constant galaxy bias in bin 2
    # priors.append(('_b2_3', (0,3)))   # for a constant galaxy bias in bin 3
    # priors.append(('_b2_4', (0,3)))  # for a constant galaxy bias in bin 4
    # priors.append(('_b2_5', (0,3)))  # for a constant galaxy bias in bin 5
    # priors.append(('_b2_6', (0,3)))  # for a constant galaxy bias in bin 6
