...
`NaMaster`, <https://github.com/LSSTDESC/NaMaster>, Alonso et al. 2019) propagate the measured $6\times2\mathrm{pt}$ 
bandpowers into cosmological parameter constraints on $w_{0}w_{a}\mathrm{CDM}$. This includes:
